...
parser.add_argument('--yaw', type=str, default='30') # ip config
...
print("rotate by velocity")
client.moveByVelocityZAsync(0,1,-1,10, airsim.DrivetrainType.MaxDegreeOfFreedom, airsim.YawMode(False, 90)).join()
client.moveByVelocityBodyFrameAsync(0,2, 0, 10, airsim.DrivetrainType.MaxDegreeOfFreedom, airsim.YawMode(False, 0)).join()
time.sleep(10)
print("yaw ", yaw)
